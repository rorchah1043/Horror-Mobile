...
public class CharacterMechanics : MonoBehaviour
{
    ...
    private void CharacterMove()
    {
        ...
        if (moveVector.x != 0 || moveVector.z != 0) ch_animator.SetBool("Walk", true); else ch_animator.SetBool("Walk", false);
    ...
    {
        if (!ch_controller.isGrounded) gravityForce -= 20f * Time.deltaTime;  else gravityForce = -1f;
